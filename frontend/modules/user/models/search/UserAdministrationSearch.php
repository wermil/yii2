...
/**
 * UserAdministrationSearch represents the model behind the search form of `frontend\modules\user\models\records\user\User`.
 */
class UserAdministrationSearch extends User
{
    /**
     * {@inheritdoc}
     */
